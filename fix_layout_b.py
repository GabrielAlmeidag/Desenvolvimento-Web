...
if match:
    ...
    new_b = '''<header id="inicio-b" class="hero-section position-relative overflow-hidden d-flex align-items-center" style="min-height: 100vh; background: url('images/justica.jpg') no-repeat center center; background-size: cover; background-attachment: fixed; padding-top: 100px; padding-bottom: 80px;">
        <!-- Overlay Claro Suave (sutil para manter a arte em evidência) -->
        ...
        <div class="container-fluid px-4 px-xl-5 position-relative z-index-2 w-100">
            <!-- Usando colunas mais largas e gap do Bootstrap para evitar colisões -->
            <div class="row align-items-center justify-content-center justify-content-xl-between gx-lg-5 h-100">
                
                <!-- Texto (Esquerda) -->
                <div class="col-lg-6 col-xl-5 offset-xl-1 text-left mt-5 mt-lg-0 mb-5 mb-lg-0" data-aos="fade-up" data-aos-duration="1000">
                    <!-- Glassmorphism Card -->
                    <div class="hero-glass-card" style="background: rgba(255, 255, 255, 0.82); backdrop-filter: blur(8px); padding: 2.5rem; border-radius: 16px; border: 1px solid rgba(255, 255, 255, 0.6); box-shadow: 0 15px 35px rgba(0,0,0,0.08); width: 100%; max-width: 600px; margin: 0 auto;">
                        ...
                        <!-- Diminuí clamp max para não estourar o card -->
                ...
                <div class="col-lg-6 col-xl-5 position-relative mt-5 mt-lg-0" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="300">
                    <div class="hero-visual-composition position-relative mx-auto shadow-lg" style="max-width: 550px; border: 1px solid rgba(212, 175, 55, 0.4); border-radius: 16px; background: #000; overflow: hidden; box-shadow: 0 25px 50px rgba(0,0,0,0.3) !important;">
                        ...
                        <div class="ratio border-0 m-0 p-0" style="--bs-aspect-ratio: 125%; cursor: pointer;" id="videoWrapperB">
                            ...
                            <div id="videoEndOverlayB" class="position-absolute w-100 h-100 top-0 start-0 z-index-3 d-flex flex-column align-items-center justify-content-center video-end-screen" style="border-radius: 12px; display: none !important;">
                                <!-- kept empty or disabled for clean loop behavior, can be customized later -->
                            </div>
                        </div>
                    </div>
                </div>
